...
namespace Nop.Web.Areas.Admin.Models.Catalog
{
        ...
        IAclSupportedModel, IDiscountSupportedModel, ILocalizedModel<ProductLocalizedModel>, IStoreMappingSupportedModel
    {
        ...
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.CustomeText")]
        ...
        public int? Api_itemId { get; set; }

        public string Api_itemCode { get; set; }//item.itemCode{get;set;}//
        public string Api_amazonItemCode { get; set; }//item.amazonItemCode{get;set;}//
        public string Api_flipkartItemCode { get; set; }//item.flipkartItemCode{get;set;}//
        public string Api_Sku { get; set; }//item.vendorSKU{get;set;}//
        public string Api_paytmItemCode { get; set; }//item.paytmItemCode{get;set;}//
        public string Api_backEndDescription { get; set; }//item.backEndDescription{get;set;}//
        public string Api_inTheBox { get; set; }//item.inTheBox{get;set;}//
        public string Api_warrantyType { get; set; }//item.warrantyType{get;set;}//
        public string Api_warranty { get; set; }//item.warranty{get;set;}//
        public string Api_specs { get; set; }//item.specs{get;set;}//
        public int? Api_marketPlaceQuantity { get; set; }//item.marketPlaceQuantity{get;set;}//
        public string Api_productHighlights { get; set; }//item.productHighlights{get;set;}//
        public string Api_fromManufacturer { get; set; }//item.fromManufacturer{get;set;}//
        public string Api_whitePaper2 { get; set; }//item.whitePaper2{get;set;}//
        public decimal? Api_specialPrice { get; set; }//item.specialPrice{get;set;}//
        public decimal? Api_rrp { get; set; }//item.rrp{get;set;}//
        public string Api_deliveryTime { get; set; }//item.deliveryTime{get;set;}//
        public bool? Api_isServiceTag { get; set; }//item.isServiceTag{get;set;}//
        public bool? Api_isUpdated { get; set; }//item.isUpdated{get;set;}//

        public string Api_Title { get; set; }//item.title{get;set;}//
