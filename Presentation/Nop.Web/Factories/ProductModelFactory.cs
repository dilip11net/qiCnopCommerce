    ...
    public partial class ProductModelFactory : IProductModelFactory
    {
            ...
            bool forceRedirectionAfterAddingToCart = false)
        {
            ...
            foreach (var product in products)
            {
                ...
                {
                    Api_Title = string.IsNullOrEmpty(product.Api_Title) ? _localizationService.GetLocalized(product, x => x.Name) : product.Api_Title ,
                    Id = product.Id,
            ...
            ShoppingCartItem updatecartitem = null, bool isAssociatedProduct = false)
        {
            ...
            var model = new ProductDetailsModel
            {
                ...
                Api_Title = string.IsNullOrEmpty(product.Api_Title) ? _localizationService.GetLocalized(product, x => x.Name) : product.Api_Title,
                Api_specs = product.Api_specs,
                Api_inTheBox = product.Api_inTheBox,
                Api_deliveryTime = product.Api_deliveryTime,
                Api_amazonItemCode = product.Api_amazonItemCode,
                Api_backEndDescription = product.Api_backEndDescription,
                Api_flipkartItemCode = product.Api_flipkartItemCode,
                Api_fromManufacturer = product.Api_fromManufacturer,
                Api_itemCode = product.Api_itemCode,
                Api_paytmItemCode = product.Api_paytmItemCode,
                Api_productHighlights = product.Api_productHighlights,
                Api_Sku = product.Api_Sku,
                Api_warranty = product.Api_warranty,
                Api_warrantyType = product.Api_warrantyType,
                Api_whitePaper2 = product.Api_whitePaper2
